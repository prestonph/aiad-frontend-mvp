	...
	'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium disabled:pointer-events-none disabled:opacity-50',
	{
		variants: {
			variant: {
				default: '',
				primary:
					'group px-5 py-[11px] lg:px-[25px] lg:py-[14px] text-[16px] font-bold leading-none text-btn-text-main hover:text-btn-text-hover capitalize transition-all duration-300 bg-btn-bg-main hover:bg-btn-bg-hover rounded-[15px] perspective-1000 overflow-hidden z-[1] gap-[30px] border border-transparent hover:border-[#41494D]',
				primary2:
				...
				primary5:
					'group px-5 py-[18px] overflow-hidden relative z-[1] bg-transparent text-btn-text-main hover:text-btn-text-hover text-[14px] !font-bold hover:!font-bold uppercase',
				primary6:
				...
				normal: 'relative text-[16px] font-medium gap-[5px] text-secondary hover:text-theme',
				normal2:
			...
			size: {
				default: 'h-[50px] md:h-[60px] px-[25px] lg:px-[30px] py-[16px] lg:py-[21px]',
				auto: 'h-auto',
