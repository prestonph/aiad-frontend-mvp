  ...
  return (
    <>
      <div className="flex min-h-full flex-1">
        ...
        <div className="flex flex-1 flex-col justify-center px-4 py-12 w-1/2 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
          <div className="mx-auto w-full max-w-sm lg:w-96">
            ...
            <div className="mt-10">
                  ...
                  <div>
                    ...
                    <div className="mt-2">
                      <input
                        ...
                        required
                        autoComplete="email"
                        className="block w-full border rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-black focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"
                      />
                    </div>
                  </div>
              ...
              <div className="mt-10">
                ...
                <div className="relative flex justify-center items-center text-sm/6 pt-6 font-medium">
                  <span className="bg-white px-6 text-gray-900">
